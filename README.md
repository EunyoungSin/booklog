...
회원가입시 JWT토큰, Resend API 기반 이메일 인증 기술이 사용되었습니다.<br>
https://booklog-theta.vercel.app/ 에서 확인 해 보실 수 있습니다.
...
- Gemini 모델: `GEMINI_MODEL` 환경변수로 지정하며, 현재 사용 중인 모델이 만료(지원 종료)되면 코드 수정 없이 이 값만 다른 모델명으로 바꿔서 대응 가능
